...
- **Environments** - the core building blocks for defining and running RL environments. Here you'll find the [base classes](env/base.md) for building your own environments, the [batched-env contract](env/batched.md) shared by every batching strategy, how to [vectorise](env/vec.md) them, and the classes used for managing [multiple](env/multi.md) at once!
